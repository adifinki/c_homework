...
int main(int argc, char* argv[]){
	printf(
		...
		"The expiration_date should be in the format: dd.mm.yyyy\n"
		"The price should be in the format: xx.yy\n\n"
		"In order to enter less than 40 items just enter the string \"STOP\"\n\n"
	);
